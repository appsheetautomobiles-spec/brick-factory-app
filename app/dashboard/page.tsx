    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      {showAdd && (
        <div className="fixed inset-0 z-30 flex items-end fade-in">
          ...
          <div className="relative w-full max-w-2xl mx-auto bg-white dark:bg-gray-800 rounded-t-3xl px-4 pt-3 pb-10 slide-up max-h-[92vh] overflow-y-auto scroll-smooth-ios">
